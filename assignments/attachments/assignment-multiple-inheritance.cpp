...
1. Name the class (one of the five named above) that represents composition with custom classes: [YOUR ANSWER HERE]
2. Name the class (one of the five named above) that uses multiple inheritance: [YOUR ANSWER HERE]
*/
